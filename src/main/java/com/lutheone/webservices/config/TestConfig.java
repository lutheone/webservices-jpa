...
import com.lutheone.webservices.entities.*;
import com.lutheone.webservices.entities.enums.OrderStatus;
import com.lutheone.webservices.repositories.*;
...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Payment pay1 = new Payment(null, o1, Instant.parse("2025-06-20T21:53:07Z"));
        o1.setPayment(pay1);
